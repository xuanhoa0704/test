var Layout = function() {
    var e = "layouts/layout3/img/",
        ...
        a = function() {
            $(".page-header .menu-toggler").on("click", function(e) {
                if (App.getViewPort().width < o) {
                    var n = $(".page-header .page-header-menu");
                    n.is(":visible") ? n.slideUp(300) : n.slideDown(300), $("body").hasClass("page-header-top-fixed") && App.scrollTop()
                }
        ...
        i = function(e, n, o) {
            var t = encodeURI(location.hash).toLowerCase(),
                a = $(".hor-menu");
            "click" === e || "set" === e ? n = $(n) : "match" === e && a.find("li > a").each(function() {
                var e = $(this).attr("ui-sref");
                if (o && e) {
                    if (o.is(e)) return void(n = $(this))
                } else {
                    var a = $(this).attr("href");
                    if (a && (a = a.toLowerCase(), a.length > 1 && t.substr(1, a.length - 1) == a.substr(1))) return void(n = $(this))
                }
            }), n && 0 != n.size() && "javascript:;" != n.attr("href") && "javascript:;" != n.attr("ui-sref") && "#" != n.attr("href") && "#" != n.attr("ui-sref") && (a.find("li.active").removeClass("active"), a.find("li > a > .selected").remove(), a.find("li.open").removeClass("open"), n.parents("li").each(function() {
        ...
        p = function() {
            ...
            navigator.userAgent.match(/iPhone|iPad|iPod/i) ? $(window).bind("touchend touchcancel touchleave", function(o) {
                $(this).scrollTop() > e ? $(".scroll-to-top").fadeIn(n) : $(".scroll-to-top").fadeOut(n)
            }) : $(window).scroll(function() {
                $(this).scrollTop() > e ? $(".scroll-to-top").fadeIn(n) : $(".scroll-to-top").fadeOut(n)
    ...
    return {
        initHeader: function(e) {
            t(), a(), App.addResizeHandler(s), App.isAngularJsApp() && i("match", null, e)
        },
        ...
        setMainMenuActiveLink: function(e, n) {
            i(e, n)
        },
        setAngularJsMainMenuActiveLink: function(e, n, o) {
            i(e, n, o)
        },
