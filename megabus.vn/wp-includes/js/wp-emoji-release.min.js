                ...
                return ("string" == typeof d ? function(d, t) {
                    return o(d, function(d) {
                        var u, f, c = d,
                            ...
                            a = t.callback(e, t);
                        if (e && a) {
                            for (f in c = "<img ".concat('class="', t.className, '" ', 'draggable="false" ', 'alt="', d, '"', ' src="', a, '"'), u = t.attributes(d, e)) u.hasOwnProperty(f) && 0 !== f.indexOf("on") && -1 === c.indexOf(" " + f + "=") && (c = c.concat(" ", f, '="', u[f].replace(b, n), '"'));
                            c = c.concat("/>")
                        }
                        return c
                    })
                    ...
                    var f, c, e, a, t, b, n, r, o, i, s, l = function d(u, f) {
                            var c, e, a = u.childNodes,
                                t = a.length;
                            for (; t--;) c = a[t], 3 === (e = c.nodeType) ? f.push(c) : 1 !== e || "ownerSVGElement" in c || h.test(c.nodeName.toLowerCase()) || d(c, f);
                            return f
                        }(d, []),
                        p = l.length;
                    for (; p--;) {
                        for (e = !1, a = document.createDocumentFragment(), t = l[p], b = t.nodeValue, n = 0; i = m.exec(b);) {
                            if ((s = i.index) !== n && a.appendChild(g(b.slice(n, s), !0)), o = i[0], i = x(o), n = s + o.length, s = u.callback(i, u), i && s) {
                        ...
                        e && (n < b.length && a.appendChild(g(b.slice(n), !0)), t.parentNode.replaceChild(a, t))
                    }
                    return d
                })(d, {
