...
export class CustomLinkManager {
    ...
    async initialize() {
        ...
        if (!((_b = this.config) === null || _b === void 0 ? void 0 : _b.unsubscribeEnabled) && await CustomLinkManager.isPushEnabled()) {
    ...
    async handleClick(element) {
        ...
        if (await CustomLinkManager.isPushEnabled()) {
            ...
            if (!await CustomLinkManager.isOptedOut()) {
                ...
                if (!((_a = this.config) === null || _a === void 0 ? void 0 : _a.unsubscribeEnabled) && await CustomLinkManager.isPushEnabled()) {
                    this.hideCustomLinkContainers();
                }
                return;
            }
