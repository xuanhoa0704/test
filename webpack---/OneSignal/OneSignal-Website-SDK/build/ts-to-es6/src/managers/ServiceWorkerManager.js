...
export class ServiceWorkerManager {
    ...
    async haveParamsChanged() {
        ...
        const serviceWorkerHrefs = ServiceWorkerHelper.getPossibleServiceWorkerHrefs(this.config, this.context.appConfig.appId);
    ...
    async installAlternatingWorker() {
        ...
        const workerHref = ServiceWorkerHelper.getAlternatingServiceWorkerHref(workerState, this.config, this.context.appConfig.appId);
        ...
        try {
            await navigator.serviceWorker.register(workerHref, {
                scope
            });
        } catch (error) {
