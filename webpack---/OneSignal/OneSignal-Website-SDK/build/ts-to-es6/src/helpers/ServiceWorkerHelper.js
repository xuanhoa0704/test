...
export default class ServiceWorkerHelper {
    ...
    static getAlternatingServiceWorkerHref(workerState, config, appId) {
        let workerFullPath;
    ...
    static getPossibleServiceWorkerHrefs(config, appId) {
    ...
    static appendServiceWorkerParams(workerFullPath, appId) {
        const fullPath = new URL(workerFullPath, OneSignalUtils.getBaseUrl()).href;
        const appIdHasQueryParam = Utils.encodeHashAsUriComponent({
            appId
        });
