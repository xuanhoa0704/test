(function() {
    ...
    */
    ...
    function ua(a) {
        ...
        (b = a.j = a.j || b) ? b.Fa ? a.h = a.o || a.m : void 0 != b.s && a.m < b.s ? (a.h = b.s, a.j = null) : a.h = a.m: a.h = 0
    }
    ...
    function za(a) {
        this.next = function(b) {
            pa(a.h);
            a.h.l ? b = xa(a, a.h.l.next, b, a.h.v) : (a.h.v(b), b = ya(a));
            return b
        };
        this.throw = function(b) {
            pa(a.h);
            a.h.l ? b = xa(a, a.h.l["throw"], b, a.h.v) : (qa(a.h, b), b = ya(a));
            return b
        };
    ...
    t("Promise", function(a) {
        ...
        b.prototype.Ta = function(g) {
            ...
            else if (g instanceof b) this.Va(g);
            else {
                a: switch (typeof g) {
                    case "object":
                        var h = null != g;
        ...
        b.prototype.ma = function(g) {
            ...
            "function" == typeof h ? this.Wa(h, g) : this.o(g)
        };
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).ea(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var r = [],
                    p = 0;
                do r.push(void 0), p++, d(k.value).ea(q(r.length - 1), m), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    var Ra = Array.prototype.indexOf ? function(a, b) {
        ...
        Sa = Array.prototype.reduce ? function(a, b, c) {
    ...
    function ib(a, b) {
        if (b) a = a.replace(jb, "&amp;").replace(kb, "&lt;").replace(lb, "&gt;").replace(mb, "&quot;").replace(nb, "&#39;").replace(ob, "&#0;");
        else {
            if (!pb.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(jb, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(kb, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(lb, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(mb, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(nb, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(ob, "&#0;"))
        }
        return a
    }
    var jb = /&/g,
    ...
    var sb = RegExp('^(?:audio/(?:3gpp2|3gpp|aac|L16|midi|mp3|mp4|mpeg|oga|ogg|opus|x-m4a|x-matroska|x-wav|wav|webm)|font/\\w+|image/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon)|video/(?:mpeg|mp4|ogg|webm|quicktime|x-matroska))(?:;\\w+=(?:\\w+|"[\\w;,= ]+"))*$', "i"),
        tb = /^data:(.*);base64,[a-z0-9+\/]+=*$/i,
        ub = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i,
        rb = {},
        vb = new qb("about:invalid#zClosurez", rb);
    var wb;
    a: {
        var xb = A.navigator;
        if (xb) {
    ...
    var Ob = I("Opera"),
        Pb = I("Trident") || I("MSIE"),
        Qb = I("Edge"),
        Rb = I("Gecko") && !(-1 != wb.toLowerCase().indexOf("webkit") && !I("Edge")) && !(I("Trident") || I("MSIE")) && !I("Edge"),
        Sb = -1 != wb.toLowerCase().indexOf("webkit") && !I("Edge");
    ...
    !I("Android") || Ab() || zb();
    Ab();
    var dc = I("Safari") && !(Ab() || I("Coast") || I("Opera") || I("Edge") || I("Edg/") || I("OPR") || zb() || I("Silk") || I("Android")) && !(Mb() || I("iPad") || I("iPod"));
    var ec = {},
        fc = null;
    var gc = {
        Gb: {
    ...
    var hc = Object,
        ic = hc.freeze,
        jc = [];
    Array.isArray(jc) && !Object.isFrozen(jc) && Object.defineProperties(jc, gc);
    ic.call(hc, jc);
    var K = window;
    gb("csi.gstatic.com");
    gb("googleads.g.doubleclick.net");
    gb("pagead2.googlesyndication.com");
    gb("partner.googleadservices.com");
    gb("pubads.g.doubleclick.net");
    gb("securepubads.g.doubleclick.net");
    gb("tpc.googlesyndication.com");
    ...
    function nc(a, b, c) {
        var d = arguments,
            ...
            f = d[1],
            g = oc(e, String(d[0]));
        f && ("string" === typeof f ? g.className = f : Array.isArray(f) ? g.className = f.join(" ") : lc(g, f));
        2 < d.length && pc(e, g, d);
        return g
    }
    ...
    var sc = {
            rb: "allow-forms",
            sb: "allow-modals",
            tb: "allow-orientation-lock",
            ub: "allow-pointer-lock",
            vb: "allow-popups",
            wb: "allow-popups-to-escape-sandbox",
            xb: "allow-presentation",
            yb: "allow-same-origin",
            zb: "allow-scripts",
    ...
    function yc() {
            ...
            for (p = 0; 80 > p; p++) {
                if (40 > p)
                    if (20 > p) {
                        var P = w ^ x & (D ^ w);
                        var G = 1518500249
                    } else P = x ^ D ^ w, G = 1859775393;
                else 60 > p ? (P = x & D | w & (x | D), G = 2400959708) : (P = x ^ D ^ w, G = 3395469782);
                P = ((q << 5 | q >>> 27) & 4294967295) + P + L + G + r[p] & 4294967295;
                L = w;
                w = D;
                D = (x << 30 | x >>> 2) & 4294967295;
                x = q;
                q = P
            }
        ...
        function c(q, r) {
            if ("string" === typeof q) {
                ...
                for (var p = [], x = 0, D = q.length; x < D; ++x) p.push(q.charCodeAt(x));
                q = p
            }
            r || (r = q.length);
            p = 0;
            if (0 == l)
                for (; p + 64 < r;) b(q.slice(p, p + 64)), p += 64, m += 64;
            for (; p < r;)
                if (f[l++] = q[p++], m++, 64 == l)
                    for (l = 0, b(f); p + 64 < r;) b(q.slice(p, p + 64)), p += 64, m += 64
        }
        ...
        function d() {
            ...
            b(f);
            for (p = r = 0; 5 > p; p++)
                for (var x = 24; 0 <= x; x -= 8) q[r++] = e[p] >> x & 255;
            return q
        }
    ...
    function zc(a, b, c) {
        ...
        return d && a && b ? [b, Ac(xc(d), a, c || null)].join(" ") : null
    }
    ...
    n.clear = function() {
        for (var a = (this.h.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = hb(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        for (a = b.length - 1; 0 <= a; a--) this.remove(b[a])
    };
    var Ec = new Dc("undefined" == typeof document ? null : document);

    function Fc(a) {
        return !!Cc.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a)
    }

    function Gc(a, b, c, d) {
        (a = A[a]) || (a = (new Dc(document)).get(b));
        return a ? zc(a, c, d) : null
    }

    function Hc(a) {
        var b = void 0 === b ? !1 : b;
        var c = xc(String(A.location.href)),
            d = [];
        var e = b;
        e = void 0 === e ? !1 : e;
        var f = A.__SAPISID || A.__APISID || A.__3PSAPISID || A.__OVERRIDE_SID;
        Fc(e) && (f = f || A.__1PSAPISID);
        if (f) e = !0;
        else {
            var g = new Dc(document);
            f = g.get("SAPISID") || g.get("APISID") || g.get("__Secure-3PAPISID") || g.get("SID");
            Fc(e) && (f = f || g.get("__Secure-1PAPISID"));
            e = !!f
        }
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new Dc(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? zc(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && Fc(b) && ((b = Gc("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = Gc("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
    ...
    function Jc(a) {
        -1 == a.h && (a.h = Sa(a.data_, function(b, c, d) {
    ...
    ad.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.m, f = this.i; d < b;) {
                if (0 == f)
                    for (; d <= c;) bd(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, ed[c]) c = ed[c];
                    else {
                        c = String(c);
                        if (!ed[c]) {
                            var f = /function\s+([^\(]+)/m.exec(c);
                            ed[c] = f ? f[1] : "[Anonymous]"
                        }
                        c = ed[c]
                    }
    ...
    var hd = "StopIteration" in A ? A.StopIteration : {
    ...
    function jd(a) {
        if (a instanceof kd || a instanceof ld || a instanceof md) return a;
        if ("function" == typeof a.next) return new kd(function() {
            return nd(a)
        });
        if ("function" == typeof a[Symbol.iterator]) return new kd(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.H) return new kd(function() {
            return nd(a.H())
        });
    ...
    ld.prototype.next = function() {
        return ld.prototype.h.call(this)
    };
    ld.prototype[Symbol.iterator] = function() {
        return new md(this.j)
    };
    ...
    n.delete = function(a) {
        return rd(this.i, a) ? (delete this.i[a], --this.size, this.j++, this.h.length > 2 * this.size && qd(this), !0) : !1
    };
    ...
    function qd(a) {
        ...
        if (a.size != a.h.length) {
            var e = {};
            for (c = b = 0; b < a.h.length;) d = a.h[b], rd(e, d) || (a.h[c++] = d, e[d] = 1), b++;
            a.h.length = c
        }
    }
    n.get = function(a, b) {
        return rd(this.i, a) ? this.i[a] : b
    };
    n.set = function(a, b) {
        rd(this.i, a) || (this.size += 1, this.h.push(a), this.j++);
        this.i[a] = b
    };
    ...
    n.keys = function() {
        return jd(this.H(!0)).i()
    };
    n.values = function() {
        return jd(this.H(!1)).i()
    };
    n.entries = function() {
        var a = this;
        return Zc(this.keys(), function(b) {
            return [b, a.get(b)]
        })
    };
    n.H = function(a) {
    ...
    var ud = function() {
        ...
        try {
            A.addEventListener("test", Ea, b), A.removeEventListener("test", Ea, b)
        } catch (c) {}
        return a
    }();
    ...
    vd.prototype.init = function(a, b) {
    ...
    Bd.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Cd(a, b, d, e); - 1 < g ? (b = a[g], c || (b.da = !1)) : (b = new zd(b, this.src, f, !!d, e), b.da = c, a.push(b));
        return b
    };
    ...
    function Dd(a, b) {
        var c = b.type;
        c in a.listeners && Ta(a.listeners[c], b) && (Ad(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--))
    }

    function Cd(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.aa && f.listener == b && f.capture == !!c && f.ia == d) return e
        }
        return -1
    };
    ...
    function Hd(a, b, c, d, e) {
        ...
        else c = Jd(c), a && a[xd] ? a.V(b, c, C(d) ? !!d.capture : !!d, e) : Kd(a, b, c, !1, d, e)
    }
    ...
    function Id(a, b, c, d, e) {
        ...
        else c = Jd(c), a && a[xd] ? a.h.add(String(b), c, !0, C(d) ? !!d.capture : !!d, e) : Kd(a, b, c, !0, d, e)
    }

    function Pd(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Pd(a, b[f], c, d, e);
        else(d = C(d) ? !!d.capture : !!d, c = Jd(c), a && a[xd]) ? a.h.remove(String(b), c, d, e) : a && (a = Ld(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = Cd(b, c, d, e)), (c = -1 < a ? b[a] : null) && Qd(c))
    }

    function Qd(a) {
        if ("number" !== typeof a && a && !a.aa) {
            var b = a.src;
            if (b && b[xd]) Dd(b.h, a);
            else {
                var c = a.type,
    ...
    function Sd(a, b) {
        ...
        a = a.ma;
        c = b.type || b;
        "string" === typeof b ? b = new td(b, a) : b instanceof td ? b.target = b.target || a : (e = b, b = new td(c, a), cb(b, e));
        e = !0;
        if (d)
        ...
        b.j || (g = b.h = a, e = Td(g, c, !0, b) && e, b.j || (e = Td(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.j && f < d.length; f++) g = b.h = d[f], e = Td(g, c, !1, b) && e
    }
    ...
    M.prototype.V = function(a, b, c, d) {
    ...
    Vd.prototype.then = function(a, b, c) {
        return $d(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
        ...
        if (0 == a.h)
            if (a.j) {
                ...
                if (c.i) {
                    ...
                    e && (0 == c.h && 1 == d ? be(c, b) : (f ? (d = f, d.next == c.l && (c.l = d), d.next = d.next.next) : ce(c), de(c, e, 3, b)))
                }
                a.j = null
            } else Wd(a, 3, b)
    }
    ...
    function $d(a, b, c, d) {
        ...
        e.h = new Vd(function(f, g) {
            ...
            e.onRejected = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof ae ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function Wd(a, b, c) {
        if (0 == a.h) {
            ...
            g || (a.u = c, a.h = b, a.j = null, fe(a), 3 != b || c instanceof ae || he(a, c))
        }
    }
    ...
    Vd.prototype.v = function() {
        for (var a; a = ce(this);) de(this, a, this.h, this.u);
        this.o = !1
    };
    ...
    n.ca = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            0 != this.o ? (this.l.push(a), this.h[a + 1] = Ea) : (c && Ta(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
        }
        return !!b
    };
    n.W = function(a, b) {
    ...
    ne.prototype.set = function(a, b) {
        void 0 === b ? this.h.remove(a) : this.h.set(a, Ud(b))
    };
    ...
    ne.prototype.remove = function(a) {
        this.h.remove(a)
    };
    ...
    function qe(a) {
        return void 0 === a || a instanceof pe ? a : new pe(a)
    }
    oe.prototype.set = function(a, b) {
        oe.K.set.call(this, a, qe(b))
    };
    oe.prototype.i = function(a) {
        a = oe.K.get.call(this, a);
    ...
    re.prototype.set = function(a, b, c) {
        if (b = qe(b)) {
            if (c) {
                if (c < Date.now()) {
                    re.prototype.remove.call(this, a);
                    return
                }
                b.expiration = c
            }
        ...
        re.K.set.call(this, a, b)
    };
    re.prototype.i = function(a) {
        var b = re.K.i.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) re.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function we(a, b) {
        ...
        this.h = null;
        var c;
        if (c = Pb) c = !(9 <= Number(ac));
        if (c) {
            xe || (xe = new od);
            this.h = xe.get(a);
            this.h || (b ? this.h = document.getElementById(b) : (this.h = document.createElement("userdata"), this.h.addBehavior("#default#userData"), document.body.appendChild(this.h)), xe.set(a, this.h));
            try {
                this.h.load(this.i)
            } catch (d) {
                this.h = null
    ...
    n.set = function(a, b) {
        this.h.setAttribute(ze(a), b);
        Ae(this)
    };
    n.get = function(a) {
        a = this.h.getAttribute(ze(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    n.remove = function(a) {
        this.h.removeAttribute(ze(a));
        Ae(this)
    };
    n.H = function(a) {
        var b = 0,
    ...
    var Ce, De, Ee = A.window,
        Fe = (null === (Ce = null === Ee || void 0 === Ee ? void 0 : Ee.yt) || void 0 === Ce ? void 0 : Ce.config_) || (null === (De = null === Ee || void 0 === Ee ? void 0 : Ee.ytcfg) || void 0 === De ? void 0 : De.data_) || {};
    E("yt.config_", Fe);

    function Ge(a) {
        for (var b = 0; b < arguments.length; ++b);
        b = arguments;
        1 < b.length ? Fe[b[0]] = b[1] : 1 === b.length && Object.assign(Fe, b[0])
    }

    function Q(a, b) {
        return a in Fe ? Fe[a] : b
    };
    var He = [];
    ...
    function Ke(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = Q("ERRORS", []), e.push([a, "ERROR", b, c, d]), Ge("ERRORS", e));
        Ie(a)
    }

    function Le(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = Q("ERRORS", []), e.push([a, "WARNING", b, c, d]), Ge("ERRORS", e))
    };
    var Me = 0;
    E("ytDomDomGetNextId", B("ytDomDomGetNextId") || function() {
        return ++Me
    });
    var Ne = {
    ...
    function Oe(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in Ne || (this[b] = a[b]);
                this.scale = a.scale;
    ...
    var Za = A.ytEventsEventsListeners || {};
    E("ytEventsEventsListeners", Za);
    var Pe = A.ytEventsEventsCounter || {
        count: 0
    };
    E("ytEventsEventsCounter", Pe);
        ...
        a && ("string" == typeof a && (a = [a]), H(a, function(b) {
            if (b in Za) {
                var c = Za[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Se() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete Za[b]
            }
        }))
    }
    ...
    function Te(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                g = Je(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Se() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                Za[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function Ye(a, b) {
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                var g = Ze(f[0] || ""),
                    h = Ze(f[1] || "");
                g in c ? Array.isArray(c[g]) ? Wa(c[g], h) : c[g] = [c[g], h] : c[g] = h
            } catch (q) {
                var k = q,
                    l = f[0],
                    m = String(Ye);
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: $e == m ? "unchanged" : m
                }];
                Xe.hasOwnProperty(l) || Le(k)
            }
        }
        return c
    }
    ...
    function df(a) {
        ...
        var c = a.match(Eb)[1] || null,
            d = Gb(a);
        c && d ? (a = a.match(Eb), b = b.match(Eb), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Gb(b) == d && (Number(b.match(Eb)[4] || null) || null) == (Number(a.match(Eb)[4] || null) || null) : !0;
        return a
    }

    function Ze(a) {
        return a && a.match(We) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function jf(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Ue(a, c || 0)
    }
    ...
    function of (a) {
        ...
        try {
            var w =
                h.screen.availWidth;
            var L = h.screen.availTop
        } catch (na) {}
        k = [x, D, k, l, w, L, m, q, r, p];
        l = b.h.top;
        try {
            var P = (l || window).document,
                G = "CSS1Compat" == P.compatMode ? P.documentElement : P.body;
            var O = (new kc(G.clientWidth, G.clientHeight)).round()
        } catch (na) {
            O = new kc(-12245933, -12245933)
        }
        P = O;
        O = {};
        G = new Ic;
        A.SVGElement && A.document.createElementNS && G.set(0);
        l = vc();
        l["allow-top-navigation-by-user-activation"] && G.set(1);
        l["allow-popups-to-escape-sandbox"] && G.set(2);
        A.crypto && A.crypto.subtle && G.set(3);
        A.TextDecoder && A.TextEncoder &&
            G.set(4);
        G = Jc(G);
        O.bc = G;
        O.bih = P.height;
        ...
        b = (O.vis = {
            ...
            preview: 4,
            unloaded: 5
        }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, O.wgl = !!K.WebGLRenderingContext, O);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var qf = "XMLHttpRequest" in A ? function() {
    ...
    function vf(a, b) {
        ...
        for (e in sf) {
            var f = Q(sf[e]);
            !f || !c && Gb(a) || d && void 0 !== b[e] || (b[e] = f)
        }
        if (c || !Gb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        if (c || !Gb(a)) {
            try {
        ...
        if (c || !Gb(a)) b["X-YouTube-Ad-Signals"] = af( of (void 0));
        return b
    }
    ...
    function wf(a) {
        var b = window.location.search,
            c = Gb(a);
        R("debug_handle_relative_url_for_query_forward_killswitch") || c || !df(a) || (c = document.location.hostname);
        var d = Fb(a.match(Eb)[5] || null);
        ...
        var d = zf(a, b),
            ...
            f = Af(a, function(k) {
                if (!e) {
                    ...
                    if (l || q || r) m = Bf(a, c, k, b.convertToSafeHtml);
    ...
    function yf(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = cf(a, b || {}, !0);
        return a
    }
    ...
    function zf(a, b) {
        ...
        b.excludeXsrf || Gb(a) && !b.withCredentials && Gb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = bf(e), cb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Jb(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!uf && a && "POST" != b.method && (uf = !0, Ke(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Le(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? Cf(a) : null) e = {}, H(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = Df(g)
                })
        }
        d && Ef(e);
    ...
    function Ef(a) {
        if (C(a))
            for (var b in a) {
                ...
                if (c) {
                    c = b;
                    gb("HTML that is escaped and sanitized server-side and passed through yt.net.ajax");
                    var d = Db(a[b], null);
                    a[c] = d
                } else Ef(a[b])
            }
    ...
    function Af(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && Je(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = rf();
        ...
        R("debug_forward_web_query_parameters") && (a = wf(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    function Jf(a, b, c, d, e) {
        e = void 0 === e ? "" : e;
        if (a)
            if (c && !Gf("cobalt")) a && (a instanceof qb || (a = "object" == typeof a && a.Z ? a.Y() : String(a), ub.test(a) ? a = new qb(a, rb) : (a = String(a), a = a.replace(/(%0A|%0D)/g, ""), a = (b = a.match(tb)) && sb.test(b[1]) ? new qb(a, rb) : null)), a = a || vb, a instanceof qb && a.constructor === qb ? a = a.h : (Fa(a), a = "type_error:SafeUrl"), "about:invalid#zClosurez" === a || a.startsWith("data") ? a = "" : (a instanceof Cb || (b = "object" == typeof a, c = null, b && a.Ea && (c = a.Ca()), a = Db(ib(b && a.Z ? a.Y() : String(a)), c)), a instanceof Cb && a.constructor === Cb ? a = a.h : (Fa(a), a = "type_error:SafeHtml"), a = encodeURIComponent(String(Ud(a.toString())))), /^[\s\xa0]*$/.test(a) || (a = nc("IFRAME", {
                src: 'javascript:"<body><img src=\\""+' + a + '+"\\"></body>"',
                style: "display:none"
            }), (9 == a.nodeType ? a : a.ownerDocument || a.document).body.appendChild(a)));
            else if (e) Af(a, b, "POST", e, d);
        else if (Q("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d) Af(a, b, "GET", "", d);
        else {
            b: {
                try {
                    var f = new Pa({
                    ...
                    if (f.j && f.i || f.l) {
                        var g = Fb(a.match(Eb)[5] || null);
                        var h = !(!g || !g.endsWith("/aclk") ||
                            "1" !== Lb(a, "ri"));
                        break b
                    }
                } catch (k) {}
    ...
    function Mf(a, b, c) {
        c = void 0 === c ? "" : c;
        Kf(a, c) ? b && b() : Jf(a, b, void 0, void 0, c)
    }
    ...
    var Nf = A.ytPubsubPubsubInstance || new N,
    ...
    N.prototype.unsubscribeByKey = N.prototype.ca;
    N.prototype.publish = N.prototype.W;
    N.prototype.clear = N.prototype.clear;
    E("ytPubsubPubsubInstance", Nf);
    E("ytPubsubPubsubTopicToKeys", Pf);
    E("ytPubsubPubsubIsSynchronous", Qf);
    E("ytPubsubPubsubSubscribedKeys", Of);
    var Rf = window,
        S = Rf.ytcsi && Rf.ytcsi.now ? Rf.ytcsi.now : Rf.performance && Rf.performance.timing && Rf.performance.now && Rf.performance.timing.navigationStart ? function() {
            return Rf.performance.timing.navigationStart + Rf.performance.now()
        } : function() {
            return (new Date).getTime()
        };
    var Sf = ff("initial_gel_batch_timeout", 2E3),
        Tf = Math.pow(2, 16) - 1,
        Uf = void 0,
        Vf = 0,
        Wf = 0,
        Xf = 0,
        Yf = !0,
        Zf = A.ytLoggingTransportGELQueue_ || new Map;
    E("ytLoggingTransportGELQueue_", Zf);
    var $f = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    E("ytLoggingTransportTokensToCttTargetIds_", $f);

    function ag(a, b) {
        if ("log_event" === a.endpoint) {
            var c = "";
            a.ga ? c = "visitorOnlyApprovedKey" : a.L && ($f[a.L.token] = bg(a.L), c = a.L.token);
            var d = Zf.get(c) || [];
            Zf.set(c, d);
            d.push(a.payload);
            b && (Uf = new b);
            a = ff("tvhtml5_logging_max_batch") || ff("web_logging_max_batch") || 100;
            b = S();
            d.length >= a ? cg({
                writeThenSend: !0
            }, R("flush_only_full_queue") ? c : void 0) : 10 <= b - Xf && (dg(), Xf = b)
        }
    }
        ...
        new Vd(function(c) {
            ...
            if (Uf && Uf.isReady())
                if (void 0 !== b) {
                    ...
                    fg(d, c, a);
                    Zf.delete(b)
                } else fg(Zf, c, a), Zf.clear();
            else dg(), c()
        })
    }

    function dg() {
        R("web_gel_timeout_cap") && !Wf && (Wf = Ue(function() {
            cg({
                writeThenSend: !0
            })
        }, 6E4));
        window.clearTimeout(Vf);
        var a = Q("LOGGING_BATCH_TIMEOUT", ff("web_gel_debounce_ms", 1E4));
        R("shorten_initial_gel_batch_timeout") && Yf && (a = Sf);
        Vf = Ue(function() {
            cg({
                writeThenSend: !0
            })
    ...
    function fg(a, b, c) {
        ...
        for (var g = a.next(); !g.done; g = a.next()) {
            ...
            R("send_beacon_before_gel") && window.navigator && window.navigator.sendBeacon && !c.writeThenSend && Mf("/generate_204");
            kg(d, "log_event", h, {
                retry: !0,
                onSuccess: function() {
                    f--;
    ...
    function jg(a, b, c) {
        ...
        !c && (b = Q("EVENT_ID", void 0)) && ((c = Q("BATCH_CLIENT_COUNTER", void 0) || 0) || (c = Math.floor(Math.random() * Tf / 2)), c++, c > Tf && (c = 1), Ge("BATCH_CLIENT_COUNTER", c), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    var lg = A.ytLoggingGelSequenceIdObj_ || {};
    ...
    function qg() {
        return "INNERTUBE_API_KEY" in Fe && "INNERTUBE_API_VERSION" in Fe
    }
    ...
    function hg() {
        return {
            ...
            eb: Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            fb: Q("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            innertubeContextClientVersion: Q("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0),
            hb: Q("INNERTUBE_CONTEXT_HL", void 0),
            gb: Q("INNERTUBE_CONTEXT_GL", void 0),
            ib: Q("INNERTUBE_HOST_OVERRIDE", void 0) || "",
            kb: !!Q("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            jb: !!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function gg(a) {
        ...
        if ("WEB" === f || "MWEB" === f || 1 === f || 2 === f) {
            ...
            var h;
            b.client.Ia = null != (h = b.client.Ia) ? h : {};
            b.client.Ia.webDisplayMode = mg()
        }
        a.appInstallData &&
        ...
        R("web_log_effective_connection_type") &&
            (a = pg(), a = null !== a && void 0 !== a && a.effectiveType ? og.hasOwnProperty(a.effectiveType) ? og[a.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, a && (b.client.effectiveConnectionType = a));
        a = Object;
        h = a.assign;
        g = b.client;
        f = {};
        e = u(Object.entries(bf(Q("DEVICE", ""))));
    ...
    function rg(a, b, c) {
        ...
        (b = c.Db || Q("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().Cb : b = Hc([]));
    ...
    function tg(a) {
        var b = new ve;
        (b = b.isAvailable() ? a ? new Be(b, a) : b : null) || (a = new we(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.h = (a = b) ? new re(a) : null;
    ...
    tg.prototype.get = function(a, b) {
        ...
        if (d && (c = Ec.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    tg.prototype.remove = function(a) {
        ...
        var b = this.i;
        Ec.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var ug;
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(S()) - d.requestTime)) {
                    var e = d.authState,
                        f = sg(rg(!1));
                    $a(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(S())), kg(a, d.method, e, {}));
                    delete b[c]
                }
            }
            vg().set("requests", b, 86400, !0)
    ...
    var zg = B("ytPubsub2Pubsub2Instance") || new N;
    N.prototype.subscribe = N.prototype.subscribe;
    N.prototype.unsubscribeByKey = N.prototype.ca;
    N.prototype.publish = N.prototype.W;
    N.prototype.clear = N.prototype.clear;
    E("ytPubsub2Pubsub2Instance", zg);
    E("ytPubsub2Pubsub2SubscribedKeys", B("ytPubsub2Pubsub2SubscribedKeys") || {});
    ...
    function Bg() {
        var a;
        return null === (a = Ag()) || void 0 === a ? void 0 : a.get("LAST_RESULT_ENTRY_KEY", !0)
    }
    ...
    function Cg(a) {
        ...
        this.i = a;
        var b, c;
        null !== (b = Ag()) && void 0 !== b && b.h && (b = {
            hasSucceededOnce: this.i.hasSucceededOnce || this.h
        }, null === (c = Ag()) || void 0 === c ? void 0 : c.set("LAST_RESULT_ENTRY_KEY", b, 2592E3, !0))
    }
    ...
    var T = {},
        Mg = (T.AUTH_INVALID = "No user identifier specified.", T.EXPLICIT_ABORT = "Transaction was explicitly aborted.", T.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", T.MISSING_INDEX = "Index not created.", T.MISSING_OBJECT_STORE = "Object store not created.", T.DB_DELETED_BY_MISSING_OBJECT_STORE = "Database is deleted because an expected object store was not created.", T.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.", T.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", T.QUOTA_MAYBE_EXCEEDED =
            "The current transaction may have failed because of exceeding quota limitations.", T.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", T.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", T),
        Ng = {},
        Og = (Ng.AUTH_INVALID = "ERROR", Ng.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", Ng.EXPLICIT_ABORT = "IGNORED", Ng.IDB_NOT_SUPPORTED = "ERROR", Ng.MISSING_INDEX = "WARNING", Ng.MISSING_OBJECT_STORE = "ERROR", Ng.DB_DELETED_BY_MISSING_OBJECT_STORE = "WARNING", Ng.QUOTA_EXCEEDED =
            "WARNING", Ng.QUOTA_MAYBE_EXCEEDED = "WARNING", Ng.UNKNOWN_ABORT = "WARNING", Ng.INCOMPATIBLE_DB_VERSION = "WARNING", Ng),
        Pg = {},
        Qg = (Pg.AUTH_INVALID = !1, Pg.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, Pg.EXPLICIT_ABORT = !1, Pg.IDB_NOT_SUPPORTED = !1, Pg.MISSING_INDEX = !1, Pg.MISSING_OBJECT_STORE = !1, Pg.DB_DELETED_BY_MISSING_OBJECT_STORE = !1, Pg.QUOTA_EXCEEDED = !1, Pg.QUOTA_MAYBE_EXCEEDED = !0, Pg.UNKNOWN_ABORT = !0, Pg.INCOMPATIBLE_DB_VERSION = !1, Pg);
    ...
    v(Sg, Error);
    var Tg = ["The database connection is closing", "Can't start a transaction on a closed database", "A mutation operation was attempted on a database that did not allow mutations"];
    ...
    function Ug(a, b, c, d) {
        ...
        if (dc && "UnknownError" === e.name) return new U("QUOTA_MAYBE_EXCEEDED", {
            objectStoreNames: c,
            dbName: b
        });
        if (e instanceof Sg) return new U("MISSING_INDEX", {
            dbName: b,
            dbVersion: d,
            objectStore: e.objectStore,
            index: e.index
        });
        if ("InvalidStateError" === e.name && Tg.some(function(f) {
    ...
    V.all = function(a) {
        return new V(new Yg(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    R: f.R
                }, ++f.R) Zg(V.resolve(a[f.R]).then(function(g) {
                return function(h) {
                    d[g.R] = h;
                    e--;
                    0 === e && b(d)
    ...
    V.prototype.then = function(a, b) {
        ...
        return new V(new Yg(function(f, g) {
            "PENDING" === c.state.status ? (c.h.push(function() {
                $g(c, c, d, f, g)
            }), c.onRejected.push(function() {
                ah(c, c, e, f, g)
            })) : "FULFILLED" === c.state.status ? $g(c, c, d, f, g) : "REJECTED" === c.state.status && ah(c, c, e, f, g)
        }))
    };
    ...
    function $g(a, b, c, d, e) {
        try {
            ...
            f instanceof V ? bh(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function eh(a, b) {
        return new V(new Yg(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
            ...
            return z(f, function(G) {
                switch (G.h) {
                    ...
                    case 2:
                        ...
                        return y(G, O, 6);
                    case 6:
                        return p = G.i, x = Math.round(S()), lh(g, q, x, l, void 0, b.join(), h), G.return(p);
                    case 4:
                        D = sa(G);
                        w = Math.round(S());
                        L = Ug(D, g.h.name, b.join(), g.h.version);
                        if ((P = L instanceof U && !L.h) || l >= k) lh(g, q, w, l, L, b.join(), h), m = L;
                        G.s(2);
                        break;
                    case 3:
                        return G.return(Promise.reject(m))
                }
            })
        })
    }
    ...
    function lh(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof U && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && Gg("QUOTA_EXCEEDED", {
            dbName: Lg(a.h.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof U && "UNKNOWN_ABORT" === e.type && (c -= a.j, 0 > c && c >= Math.pow(2, 31) && (c = 0), Gg("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.i = !0), mh(a, !1, d, f, b, g.tag), Fg(e)) : mh(a, !0, d, f, b, g.tag)
    }
    ...
    n.delete = function(a) {
        return a instanceof IDBKeyRange ? nh(this, a) : W(this.h.delete(a))
    };
    n.get = function(a) {
    ...
    n.index = function(a) {
        try {
            ...
            if (b instanceof Error && "NotFoundError" === b.name) throw new Sg(a, this.h.name);
            throw b;
        }
    };
    n.getName = function() {
    ...
    jh.prototype.abort = function() {
        this.h.abort();
        this.i = !0;
        throw new U("EXPLICIT_ABORT");
    };
    jh.prototype.objectStore = function(a) {
        a = this.h.objectStore(a);
        var b = this.j.get(a);
        b || (b = new hh(a), this.j.set(a, b));
        return b
    };
    ...
    function qh(a) {
        return W(a).then(function(b) {
            return b ? new sh(a, b) : null
        })
    }
    n = sh.prototype;
    n.advance = function(a) {
        this.cursor.advance(a);
        return qh(this.request)
    };
        ...
        return new Promise(function(d, e) {
            ...
            g.addEventListener("upgradeneeded", function(p) {
                try {
                    ...
                    p.dataLoss && "none" !== p.dataLoss && Gg("IDB_DATA_CORRUPTED", {
                        reason: p.dataLossMessage || "unknown reason",
                        dbName: Lg(a)
                    });
                    var x = f(),
                        D = new jh(g.transaction);
                    m && m(x, function(w) {
                        return p.oldVersion < w && p.newVersion >= w
                    }, D);
                    D.done.catch(function(w) {
                        e(w)
                    })
                } catch (w) {
                    e(w)
    ...
    wh.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
    ...
    wh.prototype.open = function() {
        function a() {
            return J(c, function g() {
                var h = this,
                    k, l, m, q, r;
                return z(g, function(p) {
                    switch (p.h) {
                        case 1:
                            return ra(p, 2), y(p, h.i(h.name, h.options.version, e), 4);
                        case 4:
                            k = p.i;
                            a: {
                                var x = h.options;
                                for (var D = u(Object.keys(x.ja)), w = D.next(); !w.done; w = D.next()) {
                                    w = w.value;
                                    var L = x.ja[w],
                                        P = void 0 === L.ob ? Number.MAX_VALUE : L.ob;
                                    if (k.h.version >= L.na && !(k.h.version >= P) && !k.h.objectStoreNames.contains(w)) {
                                        x = w;
                                        break a
                                    }
                                }
                            ...
                            return y(p,
                                h.delete(), 7);
                        case 7:
                            return Fg(new U("DB_DELETED_BY_MISSING_OBJECT_STORE", {
                                dbName: h.name,
                                mb: l
                            })), p.return(a());
                        case 6:
                        ...
                        case 2:
                            ...
                            return y(p, h.i(h.name, void 0, Object.assign(Object.assign({},
                                e), {
                                upgrade: void 0
                            })), 9);
                        case 9:
                            q = p.i;
                            r = q.h.version;
                            if (void 0 !== h.options.version && r > h.options.version + 1) throw q.close(), h.l = !1, xh(h, r);
                            return p.return(q);
                        case 8:
                            throw b(), m;
                    }
    ...
    function zh(a) {
        return J(this, function c() {
            ...
            return z(c, function(e) {
                if (1 == e.h) return y(e, yh.open(), 2);
                d = e.i;
                return e.return(X(d, ["databases"], {
                    D: !0,
                    mode: "readwrite"
                }, function(f) {
                    var g = f.objectStore("databases");
                    return g.get(a.actualName).then(function(h) {
                        if (h ? a.actualName !== h.actualName || a.publicName !== h.publicName || a.userIdentifier !== h.userIdentifier : 1) return W(g.h.put(a, void 0)).then(function() {})
                    })
                }))
            })
        })
    ...
    function Ah(a) {
        return J(this, function c() {
            var d;
            return z(c, function(e) {
                if (1 == e.h) return a ? y(e, yh.open(), 2) : e.return();
                d = e.i;
    ...
    function Bh(a) {
        return J(this, function c() {
            ...
            return z(c, function(f) {
                return 1 == f.h ? (d = [], y(f, yh.open(), 2)) : 3 != f.h ? (e = f.i, y(f, X(e, ["databases"], {
                    D: !0,
                    mode: "readonly"
                }, function(g) {
                    d.length = 0;
                    return oh(g.objectStore("databases"), {}, function(h) {
                        a(h.cursor.value) && d.push(h.cursor.value);
                        return h.continue()
                    })
                }), 3)) : f.return(d)
            })
        ...
        return J(this, function b() {
            ...
            return z(b, function(f) {
                switch (f.h) {
                    case 1:
                        c = Bg();
                        if (null === c || void 0 === c ? 0 : c.hasSucceededOnce) return f.return(new Cg(!0));
                        var g;
                        if (g = Ff) g = /WebKit\/([0-9]+)/.exec(wb), g = !!(g && 600 <= parseInt(g[1], 10));
                        g && (g = /WebKit\/([0-9]+)/.exec(wb), g = !(g && 602 <= parseInt(g[1], 10)));
                        if (g || Qb) return f.return(new Cg(!1));
                        try {
                            if (d = self, !(d.indexedDB && d.IDBIndex && d.IDBKeyRange && d.IDBObjectStore)) return f.return(new Cg(!1))
                        } catch (h) {
                            return f.return(new Cg(!1))
                        }
                        if (!("IDBTransaction" in
                                self && "objectStoreNames" in IDBTransaction.prototype)) return f.return(new Cg(!1));
                        ra(f, 2);
                        e = {
                        ...
                        return y(f, zh(e), 4);
                    case 4:
                        return y(f, Ah("yt-idb-test-do-not-use"), 5);
                    case 5:
                        return f.return(new Cg(!0));
                    case 2:
                        return sa(f), f.return(new Cg(!1))
                }
            })
        })
    }
    ...
    function Ih(a) {
        if (!Ig()) throw a = new U("AUTH_INVALID", {
            dbName: a
        }), Fg(a), a;
        var b = Jg();
        return {
    ...
    function Jh(a, b, c, d) {
        return J(this, function f() {
            var g, h, k, l;
            return z(f, function(m) {
                switch (m.h) {
                    case 1:
                        return y(m, Hh(), 2);
                    case 2:
                        g = m.i;
                        if (!g) throw h = Vg("openDbImpl", a, b), Fg(h), h;
                        Kg(a);
                        k = c ? {
                            actualName: a,
                            publicName: a,
                        ...
                        return y(m, zh(k), 5);
                    case 5:
                        return y(m, uh(k.actualName, b, d), 6);
                    case 6:
                        return m.return(m.i);
                    case 3:
                        return l = sa(m), ra(m, 7), y(m, Ah(k.actualName), 9);
                    case 9:
                        m.h = 8;
                        m.o = 0;
                        break;
    ...
    function Mh(a, b) {
        ...
        return J(this, function d() {
            ...
            return z(d, function(g) {
                if (1 == g.h) return y(g, Hh(), 2);
                if (3 != g.h) {
                    e = g.i;
                    if (!e) return g.return();
                    Kg(a);
                    f = Ih(a);
                    return y(g, vh(f.actualName, b), 3)
                }
                return y(g, Ah(f.actualName), 0)
            })
        })
    }
    ...
    function Nh(a, b) {
        ...
        a = a.map(function(d) {
            return J(c, function f() {
                return z(f, function(g) {
                    return 1 == g.h ? y(g, vh(d.actualName, b), 2) : y(g, Ah(d.actualName), 0)
                })
            })
        });
    ...
    Qh.prototype.i = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.va ? Lh : Kh)(a, b, Object.assign({}, c))
    };
    Qh.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.va ? Ph : Mh)(this.name, a)
    };
    ...
    function Uh() {
        if (Th) return Th();
        var a = {};
        Th = Sh("LogsDatabaseV2", {
            ja: (a.LogsRequestsStore = {
                na: 2
            }, a),
            va: !1,
            upgrade: function(b, c, d) {
                c(2) && gh(b, "LogsRequestsStore", {
                    keyPath: "id",
                    autoIncrement: !0
                });
                c(3);
        ...
        return J(this, function c() {
            ...
            return z(c, function(h) {
                ...
                if (3 != h.h) return e = h.i, f = Object.assign(Object.assign({}, a), {
                    ...
                    interface: Q("INNERTUBE_CONTEXT_CLIENT_NAME", 0)
                }), y(h, ih(e, f), 3);
                g = h.i;
                d.qb = S();
                Wh(d);
    ...
    function Xh(a) {
        return J(this, function c() {
            var d, e, f, g, h, k, l;
            return z(c, function(m) {
                if (1 == m.h) return d = {
                    startTime: S(),
                    transactionType: "YT_IDB_TRANSACTION_TYPE_READ"
                }, y(m, Uh().open(), 2);
                if (3 != m.h) return e = m.i, f = Q("INNERTUBE_CONTEXT_CLIENT_NAME", 0), g = [a, f, 0], h = [a, f, S()], k = IDBKeyRange.bound(g, h), l = void 0, y(m, X(e, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    D: !0
                }, function(q) {
                    return rh(q.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        query: k,
                        direction: "prev"
                    }, function(r) {
                        r.cursor.value && (l = r.cursor.value,
    ...
    function Yh(a) {
        return J(this, function c() {
            var d;
            return z(c, function(e) {
                if (1 == e.h) return y(e, Uh().open(), 2);
                d = e.i;
                return e.return(X(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    D: !0
                }, function(f) {
                    var g = f.objectStore("LogsRequestsStore");
                    return g.get(a).then(function(h) {
                        if (h) return h.status = "QUEUED", W(g.h.put(h, void 0)).then(function() {
                            return h
                        })
                    })
                }))
        ...
        return J(this, function c() {
            ...
            return z(c, function(e) {
                ...
                return e.return(X(d, ["LogsRequestsStore"], {
                    ...
                    var g = f.objectStore("LogsRequestsStore");
                    return g.get(a).then(function(h) {
                        return h ? (h.status = "NEW", h.sendCount += 1, W(g.h.put(h, void 0)).then(function() {
                            return h
                        })) : V.resolve(void 0)
                    })
                }))
    ...
    function ai() {
        return J(this, function b() {
            ...
            return z(b, function(e) {
                ...
                c = e.i;
                d = S() - 2592E6;
                return y(e, X(c, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    D: !0
                }, function(f) {
                    return oh(f.objectStore("LogsRequestsStore"), {}, function(g) {
                        if (g.cursor.value.timestamp <= d) return g.delete().then(function() {
                            return g.continue()
                        })
                    })
                }), 0)
    ...
    function Wh(a) {
        if (!R("nwl_csi_killswitch") && .01 >= Math.random()) {
    ...
    var ci = {},
        di = Sh("ServiceWorkerLogsDatabase", {
            ja: (ci.SWHealthLog = {
                na: 1
            }, ci),
            va: !0,
            upgrade: function(a, b) {
                b(1) && gh(a, "SWHealthLog", {
                    keyPath: "id",
                    autoIncrement: !0
    ...
    function ei() {
        J(this, function b() {
            var c, d;
            return z(b, function(e) {
                if (1 == e.h) return R("web_clean_sw_logs_store") ? y(e, di().open(), 3) : e.s(0);
                c = e.i;
                d = S() - 2592E6;
                return y(e, X(c, ["SWHealthLog"], {
                    mode: "readwrite",
                    D: !0
                }, function(f) {
                    return oh(f.objectStore("SWHealthLog"), {}, function(g) {
                        if (g.cursor.value.timestamp <= d) return g.delete().then(function() {
                            return g.continue()
                        })
                    })
    ...
    function fi() {
        return J(this, function b() {
            ...
            return z(b, function(d) {
                if (1 == d.h) return y(d, di().open(), 2);
                c = d.i;
                return y(d, c.clear("SWHealthLog"), 0)
            })
        })
    };
    var gi;
    ...
    function hi() {
        gi || (gi = new tg("yt.offline"));
        return gi
    }

    function ii(a) {
        if (R("offline_error_handling")) {
            var b = hi().get("errors", !0) || {};
            b[a.message] = {
                name: a.name,
                stack: a.stack
            };
            a.level && (b[a.message].level = a.level);
            hi().set("errors", b, 2592E3, !0)
        }
    };
    var ji = ff("network_polling_interval", 3E4);
    ...
    n.O = function(a, b) {
        a !== this.i && ((void 0 === b ? 0 : b) ? this.J() : this.i = a)
    };
    n.nb = function(a) {
        this.l = !0;
        if (void 0 === a ? 0 : a) this.G || ni(this)
    };
    n.oa = function() {
    ...
    n.V = function(a, b) {
        return M.prototype.V.call(this, a, b)
    };
    ...
    function li(a) {
        window.addEventListener("online", function() {
            return J(a, function c() {
                var d = this;
                return z(c, function(e) {
                    if (1 == e.h) return y(e, d.J(), 2);
                    if (d.S && R("offline_error_handling")) {
                        var f = hi().get("errors", !0);
                        if (f) {
                            for (var g in f)
                                if (f[g]) {
    ...
    function ni(a) {
        a.G = hf(function() {
            return J(a, function c() {
                var d = this;
                return z(c, function(e) {
                    if (1 == e.h) return d.i ? d.oa() || !d.l ? e.s(3) : y(e, d.J(), 3) : y(e, d.J(), 3);
                    ni(d);
                    e.h = 0
                })
            })
    ...
    n.J = function(a) {
        var b = this;
        return this.o ? this.o : this.o = new Promise(function(c) {
            return J(b, function e() {
                var f, g, h, k = this;
                return z(e, function(l) {
                    switch (l.h) {
                        case 1:
                            return f = window.AbortController ? new window.AbortController : void 0, g = null === f || void 0 === f ? void 0 : f.signal, h = !1, ra(l, 2, 3), f && (k.v = kf(function() {
                                f.abort()
                            }, a || 2E4)), y(l, fetch("/generate_204", {
                                method: "HEAD",
                                signal: g
                            }), 5);
                        case 5:
                        ...
                        case 3:
                            ...
                            k.o = void 0;
                            k.v && nf(k.v);
                            h !== k.i && (k.i = h, k.i && k.l ? Sd(k, "ytnetworkstatus-online") : k.l && Sd(k, "ytnetworkstatus-offline"));
                            c(h);
                            ua(l);
                            break;
                        case 2:
    ...
    Y.prototype.sendNetworkCheckRequest = Y.prototype.J;
    Y.prototype.listen = Y.prototype.V;
    Y.prototype.enableErrorFlushing = Y.prototype.cb;
    Y.prototype.getWindowStatus = Y.prototype.oa;
    Y.prototype.monitorNetworkStatusChange = Y.prototype.nb;
    Y.prototype.networkStatusHint = Y.prototype.O;
    Y.prototype.isNetworkAvailable = Y.prototype.C;
    Y.getInstance = mi;
    ...
    function oi(a) {
        ...
        c && c(a.Aa);
        a.Ha && (c = B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i)) && c();
        if (c = B("yt.networkStatusManager.instance.listen").bind(this.i)) a.la ? (this.la = a.la, c("ytnetworkstatus-online", function() {
                pi(b, "publicytnetworkstatus-online")
            }), c("ytnetworkstatus-offline", function() {
                pi(b, "publicytnetworkstatus-offline")
            })) :
            (c("ytnetworkstatus-online", function() {
                Sd(b, "publicytnetworkstatus-online")
            }), c("ytnetworkstatus-offline", function() {
                Sd(b, "publicytnetworkstatus-offline")
            }))
    }
    v(oi, M);
    oi.prototype.C = function() {
        var a = B("yt.networkStatusManager.instance.isNetworkAvailable").bind(this.i);
        return a ? a() : !0
    };
    oi.prototype.O = function(a, b) {
        b = void 0 === b ? !1 : b;
        var c = B("yt.networkStatusManager.instance.networkStatusHint").bind(this.i);
        c && c(a, b)
    };
    oi.prototype.J = function(a) {
        return J(this, function c() {
            var d = this,
                e;
            return z(c, function(f) {
                return (e = B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(d.i)) ? f.return(e(a)) : f.return(!0)
            })
        })
    };

    function pi(a, b) {
        a.la ? a.l ? (nf(a.v), a.v = kf(function() {
            a.o !== b && (Sd(a, b), a.o = b, a.l = S())
        }, a.la - (S() - a.l))) : (Sd(a, b), a.o = b, a.l = S()) : Sd(a, b)
    };
    var qi = 0,
        ri = 0,
        si, ti = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
            databaseToken: void 0,
            potentialEsfErrorCounter: ri,
            isIdbSupported: !1
        };
    E("ytNetworklessLoggingInitializationOptions", ti);

    function ui(a, b) {
        function c(d) {
            var e = vi().C();
            if (!wi() || !d || e && R("vss_networkless_bypass_write")) xi(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        R("skip_is_supported_killswitch") ? Hh().then(function(d) {
            c(d)
        }) : c(zi())
    }
        ...
        function c(d) {
            if (wi() && d) {
                ...
                e.options.onSuccess = function(h, k) {
                    void 0 !== e.id ? $h(e.id, d) : f = !0;
                    R("vss_network_hint") && vi().O(!0);
                    g(h, k)
                };
                xi(e.url, e.options);
                Vh(e, d).then(function(h) {
                    e.id = h;
                    f && $h(e.id, d)
                }).catch(function(h) {
                    vi().C() ? Ke(h) : ii(h)
    ...
    function Bi() {
        var a = this,
            b = zi();
        if (!b) throw Vg("throttleSend");
        qi || (qi = kf(function() {
            return J(a, function d() {
                var e;
                return z(d, function(f) {
                    if (1 == f.h) return y(f, Xh("NEW", b), 2);
                    if (3 != f.h) return e = f.i, e ? y(f, yi(e), 3) : (nf(qi), qi = 0, f.return());
                    qi && (qi = 0, Bi());
                    f.h = 0
                })
            })
        ...
        return J(this, function c() {
            ...
            return z(c, function(g) {
                switch (g.h) {
                    case 1:
                        d = zi();
                        if (!d) throw e = Vg("immediateSend"), e;
                        if (void 0 === a.id) {
                            g.s(2);
                            break
                        }
                        return y(g, Yh(a.id, d), 3);
                    case 3:
                        (f = g.i) ? a = f: Le(Error("The request cannot be found in the database."));
                    case 2:
                        var h = a.timestamp;
                        if (!(2592E6 <= S() - h)) {
                            g.s(4);
                        ...
                        Le(Error("Networkless Logging: Stored logs request expired age limit"));
                        if (void 0 === a.id) {
                            g.s(5);
                            break
                        }
                        return y(g, $h(a.id, d), 5);
                    case 5:
                        return g.return();
                    case 4:
                        a.skipRetry ||
                        ...
                        h = a;
                        var k, l;
                        if (null === (l = null === (k = null === h || void 0 === h ? void 0 : h.options) || void 0 === k ? void 0 : k.postParams) || void 0 === l ? 0 : l.requestTimeMs) h.options.postParams.requestTimeMs = Math.round(S());
                        a = h;
                        if (!a) {
                            g.s(0);
                            break
                        ...
                        return y(g, $h(a.id, d), 8);
                    case 8:
                        xi(a.url, a.options, !!a.skipRetry), g.h = 0
                }
            })
        })
    }
    ...
    function Ci(a) {
        var b = this,
            c = zi();
        if (!c) throw Vg("updateRequestHandlers");
        var d = a.options.onError ? a.options.onError : function() {};
        a.options.onError = function(f, g) {
            return J(b, function k() {
                return z(k, function(l) {
                    switch (l.h) {
                        case 1:
                            if (!((B("ytNetworklessLoggingInitializationOptions") ? ti.potentialEsfErrorCounter : ri) <= ff("potential_esf_error_limit", 10))) {
                                l.s(2);
                                break
                            }
                            return y(l, vi().J(), 3);
                        case 3:
                            if (vi().C()) B("ytNetworklessLoggingInitializationOptions") && ti.potentialEsfErrorCounter++, ri++;
                        ...
                        case 2:
                            ...
                            return 1 > a.sendCount ? y(l, Zh(a.id, c), 8) : y(l, $h(a.id,
                                c), 4);
                        case 8:
                            kf(function() {
                                vi().C() && Bi()
        ...
        a.options.onSuccess = function(f, g) {
            return J(b, function k() {
                return z(k, function(l) {
                    if (1 == l.h) return void 0 === (null === a || void 0 === a ? void 0 : a.id) ? l.s(2) : y(l, $h(a.id, c), 2);
                    R("vss_network_hint") && vi().O(!0);
                    e(f, g);
                    l.h = 0
                })
    ...
    function xi(a, b, c) {
        if (R("networkless_with_beacon")) {
            ...
            c ? xf(a, b) : Mf(a, void 0, b.postBody)
        } else c && 0 === Object.keys(b).length ? Jf(a) : xf(a, b)
    }

    function wi() {
        return B("ytNetworklessLoggingInitializationOptions") ? ti.isNwlInitialized : !1
    }

    function zi() {
        return B("ytNetworklessLoggingInitializationOptions") ? ti.databaseToken : void 0
    };
    ...
    function Di(a) {
        ...
        this.U = function() {};
        this.now = Date.now;
        this.Ra = null !== (b = a.Ra) && void 0 !== b ? b : 100;
        this.Pa = null !== (c = a.Pa) && void 0 !== c ? c : 1;
        this.Ma = null !== (d = a.Ma) && void 0 !== d ? d : 2592E6;
        this.La = null !== (e = a.La) && void 0 !== e ? e : 12E4;
        this.Oa = null !== (f = a.Oa) && void 0 !== f ? f : 5E3;
        this.databaseToken = null !== (g = a.databaseToken) && void 0 !== g ? g : void 0;
        this.ha = !!a.ha;
        this.fa = null !== (h = a.fa) && void 0 !== h ? h : .1;
        ...
        this.sa = a.sa;
        this.ra = a.ra;
        this.databaseToken && (!this.F || this.F("networkless_logging")) && Ei(this)
    }
    ...
    function Ei(a) {
        J(a, function c() {
            ...
            return z(c, function(e) {
                ...
                Fi(d);
                d.B.C() && d.ba();
                d.B.V(d.sa, d.ba.bind(d));
                d.B.V(d.ra, d.xa.bind(d));
                d.h = !0;
                return d.ha && Math.random() <= d.fa ? y(e, d.A.ab(d.databaseToken), 0) : e.s(0)
            })
        })
    }
    n = Di.prototype;
    n.writeThenSend = function(a, b) {
        ...
        if (this.databaseToken && this.h) {
            ...
            this.A.set(d, this.databaseToken).then(function(e) {
                d.id = e;
                c.B.C() && Gi(c, d)
            }).catch(function(e) {
                Gi(c, d);
    ...
    n.sendThenWrite = function(a, b, c) {
        ...
        if (this.databaseToken && this.h) {
            ...
            if (this.B.C()) {
                if (!e.skipRetry) {
                    ...
                    b.onError = function(g, h) {
                        return J(d, function l() {
                            var m = this,
                                q;
                            return z(l, function(r) {
                                if (1 == r.h) return q = m, y(r, m.A.set(e, m.databaseToken).catch(function(p) {
                                    Hi(q, p)
                                }), 2);
                                f(g, h);
                                r.h = 0
            ...
            } else this.A.set(e, this.databaseToken).catch(function(g) {
                Hi(d, g)
            })
        } else this.P(a, b, this.F && this.F("nwl_skip_retry") && c)
    };
    n.sendAndWrite = function(a, b) {
        ...
        if (this.databaseToken && this.h) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.A.T(d.id, c.databaseToken) : e = !0;
                c.B.O && c.F && c.F("vss_network_hint") && c.B.O(!0);
                f(g, h)
            };
            this.P(d.url, d.options);
            this.A.set(d, this.databaseToken).then(function(g) {
                d.id = g;
                e && c.A.T(d.id, c.databaseToken)
            }).catch(function(g) {
                Hi(c, g)
            })
        } else this.P(a, b)
    ...
    n.ba = function() {
        var a = this;
        if (!this.databaseToken) throw Vg("throttleSend");
        this.i || (this.i = kf(function() {
            return J(a, function c() {
                var d = this,
                    e;
                return z(c, function(f) {
                    if (1 == f.h) return y(f, d.A.Da("NEW", d.databaseToken), 2);
                    if (3 != f.h) return e = f.i, e ? y(f, Gi(d, e), 3) : (d.xa(), f.return());
                    d.i && (d.i = 0, d.ba());
                    f.h = 0
                })
            })
    ...
    function Gi(a, b) {
        return J(a, function d() {
            ...
            return z(d, function(h) {
                switch (h.h) {
                    case 1:
                        if (!e.databaseToken) throw f = Vg("immediateSend"), f;
                        if (void 0 === b.id) {
                            h.s(2);
                            break
                        }
                        return y(h, e.A.lb(b.id, e.databaseToken), 3);
                    case 3:
                        (g = h.i) ? b = g: e.U(Error("The request cannot be found in the database."));
                    case 2:
                        if (Ii(e, b, e.Ma)) {
                            h.s(4);
                            break
                        }
                        e.U(Error("Networkless Logging: Stored logs request expired age limit"));
                        if (void 0 === b.id) {
                            h.s(5);
                            break
                        }
                        return y(h, e.A.T(b.id, e.databaseToken), 5);
                    case 5:
                        return h.return();
                    case 4:
                        b.skipRetry || (b = Ji(e, b));
                        if (!b) {
                            h.s(0);
                            break
                        }
                        ...
                        return y(h, e.A.T(b.id, e.databaseToken), 8);
                    case 8:
                        e.P(b.url, b.options, !!b.skipRetry), h.h = 0
                }
            })
        })
    }
    ...
    function Ji(a, b) {
        if (!a.databaseToken) throw Vg("updateRequestHandlers");
        var c = b.options.onError ? b.options.onError : function() {};
        b.options.onError = function(e, f) {
            return J(a, function h() {
                var k = this,
                    l;
                return z(h, function(m) {
                    switch (m.h) {
                        case 1:
                            l = k;
                            if (!(k.potentialEsfErrorCounter <= k.ta)) {
                                m.s(2);
                                break
                            }
                            if (!k.B.J) {
                            ...
                            return y(m, k.B.J(), 3);
                        case 3:
                            if (k.B.C()) k.potentialEsfErrorCounter++;
                            else return c(e, f), m.return();
                        case 2:
                            if (void 0 === (null === b || void 0 === b ? void 0 : b.id)) {
                                m.s(5);
                                break
                            }
                            return b.sendCount < k.Pa ? y(m, k.A.Na(b.id, k.databaseToken), 9) : y(m, k.A.T(b.id, k.databaseToken), 5);
                        case 9:
                            kf(function() {
                                l.B.C() && l.ba()
                            }, k.Oa);
        ...
        b.options.onSuccess = function(e, f) {
            return J(a, function h() {
                var k = this;
                return z(h, function(l) {
                    if (1 == l.h) return void 0 === (null === b || void 0 === b ? void 0 : b.id) ? l.s(2) : y(l, k.A.T(b.id, k.databaseToken), 2);
                    k.B.O && k.F && k.F("vss_network_hint") && k.B.O(!0);
                    d(e, f);
                    l.h = 0
                })
            })
    ...
    function Fi(a) {
        if (!a.databaseToken) throw Vg("retryQueuedRequests");
        a.A.Da("QUEUED", a.databaseToken).then(function(b) {
            b && !Ii(a, b, a.La) ? kf(function() {
                return J(a, function d() {
                    var e = this;
                    return z(d, function(f) {
                        if (1 == f.h) return void 0 === b.id ? f.s(2) : y(f, e.A.Na(b.id, e.databaseToken), 2);
                        Fi(e);
                        f.h = 0
                    })
                })
    ...
    function Hi(a, b) {
        a.Sa && !a.B.C() ? a.Sa(b) : a.handleError(b)
    };
    ...
    function Ki() {
        Di.call(this, {
            ...
            Sa: ii,
            Ga: mf(),
            sa: "publicytnetworkstatus-online",
            ra: "publicytnetworkstatus-offline",
            ha: !0,
            fa: .1,
            ta: ff("potential_esf_error_limit", 10),
            F: R
        });
        this.ha && Math.random() <= this.fa && this.databaseToken && ei();
        R("networkless_immediately_drop_sw_health_store") && Mi(this);
        R("networkless_immediately_drop_all_requests") && bi();
        Ph("LogsDatabaseV2")
    }
    v(Ki, Di);
    ...
    function Ni() {
        ...
        a || (a = new Ki, E("yt.networklessRequestController.instance", a), R("networkless_logging") && Hh().then(function(b) {
            a.databaseToken = b;
            Ei(a)
        }));
        return a
    }
    Ki.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        Ig() || (this.h = !1);
        Di.prototype.writeThenSend.call(this, a, b)
    };
    Ki.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        Ig() || (this.h = !1);
        Di.prototype.sendThenWrite.call(this, a, b, c)
    };
    Ki.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        Ig() || (this.h = !1);
        Di.prototype.sendAndWrite.call(this, a, b)
    };
    ...
    function Mi(a) {
        J(a, function c() {
            ...
            return z(c, function(g) {
                e = d;
                if (!d.databaseToken) throw f = Vg("clearSWHealthLogsDb"), f;
                return g.return(fi().catch(function(h) {
                    e.handleError(h)
                }))
            })
        })
    ...
    function Li(a, b, c) {
        var d;
        if (null === (d = b.postParams) || void 0 === d ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(S());
        if (R("networkless_with_beacon")) {
            c = b;
    ...
    function kg(a, b, c, d) {
        function e(r) {
            r = void 0 === r ? !1 : r;
            var p;
            if (d.retry && "www.youtube-nocookie.com" != h && (r || R("skip_ls_gel_retry") || (p = wg(b, c, l, k)), p)) {
                var x = g.onSuccess,
                    D = g.onFetchSuccess;
                g.onSuccess = function(w, L) {
                    xg(p);
                    x(w, L)
                };
                c.onFetchSuccess = function(w, L) {
                    xg(p);
                    D(w, L)
                }
            }
            try {
                r && d.retry && !d.Ja.bypassNetworkless ? (g.method = "POST", d.Ja.writeThenSend ? R("use_new_nwl") ? Ni().writeThenSend(q, g) : ui(q, g) : R("use_new_nwl") ? Ni().sendAndWrite(q, g) : Ai(q, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), xf(q, g))
            } catch (w) {
                if ("InvalidAccessError" == w.name) p && (xg(p), p = 0), Le(Error("An extension is blocking network request."));
                else throw w;
            }
            p && hf(function() {
                yg(a)
            }, 5E3)
        }!Q("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Le(new Hg("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        a.config_.jb && g.headers.Authorization || (m.key = a.config_.innertubeApiKey);
        var q = cf("" + h + f, m || {}, !0);
        R("use_new_nwl") || wi() ? Gh().then(function(r) {
            e(r)
        }) : e(!1)
    };
    ...
    function Pi(a, b) {
        var c = void 0 === c ? {} : c;
        var d = Oi;
        Q("ytLoggingEventsDefaultDisabled", !1) && Oi == Oi && (d = null);
        c = void 0 === c ? {} : c;
        var e = {},
            f = Math.round(c.timestamp || S());
        ...
        R("log_sequence_info_on_gel_web") && c.Qa && (a = e.context, b = c.Qa, lg[b] = b in lg ? lg[b] + 1 : 0, a.sequence = {
            index: lg[b],
            groupKey: b
        }, c.Fb && delete lg[c.Qa]);
        (c.Kb ? eg : ag)({
    ...
    function Vi() {
        if (!Ui) {
            ...
            a.N.length = 0;
            a.M.length = 0;
            Si.N && a.N.push.apply(a.N, Si.N);
            Si.M && a.M.push.apply(a.M, Si.M)
        }
        return Ui
    };
    var Wi = new N;
    ...
    function Zi(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += $i(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = Xi(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? $i(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += $i(e, a[e], b, c);
                    if (500 < d) break
                }
            } else c[b] = aj(a), d += c[b].length;
        else c[b] = aj(a), d += c[b].length;
        return d
    }
    ...
    var bj = new Set,
        ...
        ej = 0,
        fj = [],
        gj = ["PhantomJS", "Googlebot", "TO STOP THIS SECURITY SCAN go/scan"];
    var hj = {};

    function ij(a) {
        return hj[a] || (hj[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function mj() {
        for (var a = u(kj), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }

    function nj(a, b) {
        var c;
        "yt:" === a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[ij(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function oj(a, b) {
        for (var c = 1; c < arguments.length; ++c);
        le.W.apply(le, arguments)
    };
    ...
    function qj(a, b, c) {
        rj || (rj = {}, Te(window, "message", function(d) {
            a: {
                if (d.origin === Z(a, "host")) {
                    ...
                    if (d = rj[e.id]) d.u = !0, d.u && (H(d.o, d.sendMessage, d), d.o.length = 0), d.wa(e)
                }
                e = void 0
            }
            return e
    ...
    n.destroy = function() {
        this.h && this.h.id && (jj[this.h.id] = null);
        var a = this.l;
    ...
    function wj(a, b, c) {
        ...
        a.u ? a.sendMessage(b) : a.o.push(b)
    }
    ...
    function xj(a, b) {
        ...
        (b = Z(a.i, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.za();
        g.enablejsapi = window.postMessage ? 1 : 0;
        window.location.host && (g.origin = window.location.protocol + "//" + window.location.host);
        g.widgetid = a.id;
        window.location.href && H(["debugjs", "debugcss"], function(h) {
            var k = Lb(window.location.href, h);
            null !== k && (g[h] = k)
        });
        ...
        c.src = Z(a.i, "host") + ("/embed/" + Z(a.i, "videoId")) + "?" + Jb(g);
        return c
    }
    n.Ka = function() {
    ...
    n.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Hb(a.src) : "https://www.youtube.com"), this.i = new pj(b), c || (b = xj(this, a), this.m = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.h = a, this.h.id || (this.h.id = "widget" + Ha(this.h)), jj[this.h.id] = this, window.postMessage) {
                this.l = new N;
                yj(this);
                b = Z(this.i, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in lj) lj.hasOwnProperty(e) &&
                    vj(this, e)
            }
    };

    function uj(a, b) {
        a.G[b] || (a.G[b] = !0, wj(a, "addEventListener", [b]))
    }
    n.sendMessage = function(a) {
        a.id = this.id;
        a.channel = "widget";
        a = Ud(a);
        var b = [Hb(this.h.src || "").replace("http:", "https:")];
        if (this.h.contentWindow)
            for (var c = 0; c < b.length; c++) try {
                this.h.contentWindow.postMessage(a, b[c])
            } catch (w) {
                if (w.name && "SyntaxError" === w.name) {
                    if (!(w.message && 0 < w.message.indexOf("target origin ''"))) {
                        var d = void 0,
                            e = w;
                        d = void 0 === d ? {} : d;
                        d.name = Q("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                        d.version = Q("INNERTUBE_CONTEXT_CLIENT_VERSION", void 0);
                        var f = d || {};
                        d = "WARNING";
                        d = void 0 === d ? "ERROR" : d;
                        if (e) {
                            ...
                            if (!(5 <= cj)) {
                                ...
                                if (e.hasOwnProperty("args") && e.args && e.args.length)
                                    for (g = 0; g < e.args.length && !(r = Zi(e.args[g], "params." + g, k, r), 500 <= r); g++);
                                ...
                                if (fj.length)
                                    for (g = 0; g < fj.length && !(r = Zi(fj[g], "params.context." +
                                            g, k, r), 500 <= r); g++);
                                ...
                                if ("IGNORED" === e.level) e = 0;
                                    ...
                                    for (h = f.next(); !h.done; h = f.next())
                                        if (h = h.value, g.message && g.message.match(h.Hb)) {
                                            e = h.weight;
                                            break a
                                        }
                                    e = u(e.M);
                                ...
                                for (f = g.next(); !f.done; f = g.next())
                                    if (f = f.value, f.ka[e.name])
                                        for (q = u(f.ka[e.name]), h = q.next(); !h.done; h = q.next())
                                            if (l = h.value, h = e.message.match(l.regexp)) {
                                                e.params["params.error.original"] = h[0];
                                                q = l.groups;
                                                l = {};
                                                for (m = 0; m < q.length; m++) l[q[m]] = h[m + 1], e.params["params.error." + q[m]] = h[m + 1];
                                                e.message = f.qa(l);
                                                break
                                            }
                                e.params || (e.params = {});
                                g = Vi();
                                e.params["params.errorServiceSignature"] = "msg=" + g.N.length + "&cb=" + g.M.length;
                                e.params["params.serviceWorker"] = "false";
                                A.document && A.document.querySelectorAll &&
                                    (e.params["params.fscripts"] = String(document.querySelectorAll("script:not([nonce])").length));
                                gb("sample").constructor !== eb && (e.params["params.fconst"] = "true");
                                window.yterr && "function" === typeof window.yterr && window.yterr(e);
                                if (0 !== e.sampleWeight && !bj.has(e.message)) {
                                    "ERROR" === d ? (Wi.W("handleError", e), R("record_app_crashed_web") && 0 === ej && 1 === e.sampleWeight && (ej++, Pi("appCrashed", {
                                        appCrashType: "APP_CRASH_TYPE_BREAKPAD"
                                    })), dj++) : "WARNING" === d && Wi.W("handleWarning", e);
                                    if (R("kevlar_gel_error_routing")) {
                                        ...
                                        if (f) f = void 0;
                                            ...
                                            f = l.lineNumber && l.lineNumber.split ? l.lineNumber.split(":") : [];
                                            0 !== f.length && (1 !== f.length || isNaN(Number(f[0])) ? 2 !== f.length || isNaN(Number(f[0])) || isNaN(Number(f[1])) || (h.lineNumber = Number(f[0]), h.columnNumber = Number(f[1])) : h.lineNumber = Number(f[0]));
                                            f = {
                                            ...
                                            Q("FEXP_EXPERIMENTS") && (q.experimentIds = Q("FEXP_EXPERIMENTS"));
                                            if (l = l.params)
                                                for (m = u(Object.keys(l)), k = m.next(); !k.done; k = m.next()) k = k.value, q.kvPairs.push({
                                                    key: "client." + k,
                                                    value: String(l[k])
                                                });
                                            l = Q("SERVER_NAME", void 0);
                                            m = Q("SERVER_VERSION", void 0);
                                            l && m && (q.kvPairs.push({
                                                key: "server.name",
                                                value: l
                                            }), q.kvPairs.push({
                                        ...
                                        f && (Pi("clientError", f), ("ERROR" === g || R("errors_flush_gel_always_killswitch")) && cg())
                                    }
                                    if (!R("suppress_error_204_logging")) {
                                        ...
                                        if (d.postParams) {
                                            ...
                                            if (g = Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0))
                                                for (f = u(Object.keys(g)), h = f.next(); !h.done; h = f.next()) h = h.value, d.postParams[h] = g[h];
                                            g = Q("SERVER_NAME", void 0);
                                            f = Q("SERVER_VERSION", void 0);
                                            g && f && (d.postParams["server.name"] = g, d.postParams["server.version"] = f)
                                        }
                                        xf(Q("ECATCHER_REPORT_HOST", "") + "/error_204", d)
                                    }
                                    try {
                                        bj.add(e.message)
                                    } catch (L) {}
    ...
    n.wa = function(a) {
        ...
        switch (b) {
            case "apiInfoDelivery":
                if (C(a))
                    for (var c in a) a.hasOwnProperty(c) && (this.I[c] = a[c]);
                break;
            case "infoDelivery":
                Cj(this, a);
                break;
            case "initialDelivery":
                C(a) && (window.clearInterval(this.j), this.playerInfo = {}, this.I = {}, Dj(this, a.apiInterface), Cj(this, a));
                break;
            default:
                tj(this, b, a)
        }
    ...
    function Dj(a, b) {
        H(b, function(c) {
            this[c] || ("getCurrentTime" === c ? this[c] = function() {
                ...
                return d
            } : zj(c) ? this[c] = function() {
                this.playerInfo = {};
                this.I = {};
                wj(this, c, arguments);
                return this
            } : Aj(c) ? this[c] = function() {
                var d = 0;
    ...
    n.getOptions = function(a) {
        return this.I.namespaces ? a ? this.I[a] ? this.I[a].options || [] : [] : this.I.namespaces || [] : []
    };
    n.getOption = function(a, b) {
        if (this.I.namespaces && a && b && this.I[a]) return this.I[a][b]
    };
    ...
    E("YT.subscribe", function(a, b, c) {
        le.subscribe(a, b, c);
        lj[a] = !0;
        for (var d in jj) jj.hasOwnProperty(d) && vj(jj[d], a)
    });
    E("YT.unsubscribe", function(a, b, c) {
        ke(a, b, c)
    });
    E("YT.Player", Bj);
    sj.prototype.destroy = sj.prototype.destroy;
    sj.prototype.setSize = sj.prototype.setSize;
    sj.prototype.getIframe = sj.prototype.Xa;
    sj.prototype.addEventListener = sj.prototype.addEventListener;
    Bj.prototype.getVideoEmbedCode = Bj.prototype.getVideoEmbedCode;
    Bj.prototype.getOptions = Bj.prototype.getOptions;
    Bj.prototype.getOption = Bj.prototype.getOption;
    kj.push(function(a) {
        var b = a;
        b || (b = document);
        ...
        if (c.querySelectorAll && c.querySelector) b = c.querySelectorAll(".yt-player");
            ...
            if (b.querySelectorAll && b.querySelector) b = b.querySelectorAll(".yt-player");
                ...
                for (c = d = 0; b = e[c]; c++) {
                    var g = b.className,
                        h;
                    if (h = "function" == typeof g.split) h = 0 <= Ra(g.split(/\s+/),
                        "yt-player");
                    h && (f[d++] = b)
                }
                f.length = d;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || mj();
    var Fj = A.onYTReady;
    Fj && Fj();
    var Gj = A.onYouTubeIframeAPIReady;
    Gj && Gj();
    var Hj = A.onYouTubePlayerAPIReady;
    Hj && Hj();
}).call(this);